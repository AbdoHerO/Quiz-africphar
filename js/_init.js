$(function(){
    ...
    slideChanged = function(data) {
        ...
        $("#numSlideMobile").html((data.position + 1) + "/" + data.count);
        ...
        $(".is_chapter").each(function() {
            ...
            if(slideshow && slideshow._xmlReader && slideshow._xmlReader.disableBackButtons ){
                activateLink = activateLink && parseInt($this.attr("data-slide")) > currentMaxSlide;
            }
    ...
    buttonStateChanged = function(data) {
        ...
        for(var btn in data) {
            ...
            if(slideshow && slideshow._xmlReader && slideshow._xmlReader.disableBackButtons && (btn == 'previous' || btn == 'first') ) data[btn].f_dis_activate = true;

            $("#" + btn).css("cursor", data[btn].activate ? "pointer" : "default");

			if (data[btn].activate && !data[btn].f_dis_activate)
            ...
            switch(btn) {
                ...
                case 'next':
                    ...
                    break;
                case 'play':
                    if (data[btn].state != "play" && !data[btn].f_dis_activate) {
